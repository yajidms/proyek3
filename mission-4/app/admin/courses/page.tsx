...
export default function AdminCoursesPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Manajemen Mata Kuliah</h1>
          ...
          <form onSubmit={handleSubmit} className="p-4 bg-white shadow rounded-lg space-y-4">
            ...
            <div>
              ...
              <input type="number" name="sks" value={form.sks} onChange={handleFormChange}
                     className={`mt-1 block w-full border rounded-md p-2 ${errors.sks ? 'border-red-500' : 'border-gray-300'}`} />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-xl">
            ...
            <div className="flex justify-end space-x-4">
              <button onClick={() => setShowConfirm(false)} className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Batal</button>
